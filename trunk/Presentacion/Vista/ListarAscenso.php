    ...
    <body>
        ...
        <div class="content">
            <div class="content_resize">
                <fieldset><legend>LISTADO DE ASCENSOS</legend><br>
                    <center> <table id="rounded-corner" summary="2007 Major IT Companies' Profit">
                            <thead>
                                <tr>
                                    <th scope="col" class="rounded-company">Niveles</th>                                                                                                         
                                    <th scope="col" class="rounded-q4">Estado</th>                                    
                                </tr>
                            </thead>
                            <tfoot>
                                <tr>
                            ...
                            <tbody>
                                ...
                                foreach ($lista as $lista):
                                    ?>                                    
                                <td><?php echo $lista->get_nivel() ?> </td>
                                <td><?php echo $lista->get_estado() ?> </td>                                                                              
                                </tr>
                            <?php endforeach; ?>
                            </tbody>
                        </table></center>
