    ...
    <body>
        ...
        <div class="content">
            <div class="content_resize">
                <form method="post" action="index.php?task=BuscarDocentesPublicacion" class="iform" name="form1">
                    <ul>
                                ...
                                <tbody>
                                    ...
                                    foreach ($datosBuscados as $lista):
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="index.php?task=IngresarPublicaciones&cedula=<?php echo $lista->get_cedula() ?>&nombres=<?php echo $lista->get_nombres() ?>&apellidos=<?php echo $lista->get_apellidos() ?>"><input class="iradio" type="radio" name="op" value="2" checked><label for="" class="ilabel">Ok</label></a></td>                                
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
                            </table>
